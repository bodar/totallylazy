...
public class CallablesTest {
    ...
    public void canCurrySingleArgumentCallablesAsWell() throws Exception {
        final Function1<Number, Function1<Number, Number>> curriedAdd = Callables.curry(add());
        final Callable<Number> numberNumberCallable1 = Callables.partial(curriedAdd.call(1), 2);

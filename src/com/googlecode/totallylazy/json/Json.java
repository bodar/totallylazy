...
public class Json {
    ...
    public static class functions {
        public static Function<String, Map<String, Object>> toMap = new Function<String, Map<String, Object>>() {
            public Map<String, Object> call(String json) throws Exception {
                return Json.map(json);
            }
        };

        public static Function<Object, String> toJson = new Function<Object, String>() {

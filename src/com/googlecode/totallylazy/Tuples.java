...
public class Tuples {
    public static <F, S> Function2<Pair<F, S>, Pair<F, S>, Pair<F, S>> to(final Function2<? super F, ? super F, ? extends F> first,
    ...
    public static <F, S, T> Function2<Triple<F, S, T>, Triple<F, S, T>, Triple<F, S, T>> to(final Function2<? super F, ? super F, ? extends F> first,
                                                                                            final Function2<? super S, ? super S, ? extends S> second,

...
public class AtomicMap<K, V> implements ConcurrentMap<K, V> {
    ...
    public V put(final K key, final V value) {
        return atomic.modifyReturn(new Function<PersistentMap<K, V>, Pair<PersistentMap<K, V>, V>>() {
            @Override
    ...
    public void putAll(final Map<? extends K, ? extends V> m) {
        atomic.modify(new Unary<PersistentMap<K, V>>() {
            @Override
    ...
    public boolean remove(final Object rawKey, final Object value) {
        return atomic.modifyReturn(new Function<PersistentMap<K, V>, Pair<PersistentMap<K, V>, Boolean>>() {
            @Override

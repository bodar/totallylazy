...
public class SetFunctionType extends TextOnlyExpression {
    ...
    public SetFunctionType(Callable2<?, ?, ?> callable, String column) {
        super(functionName(callable.getClass(), column));
    }

    public static String functionName(final Class<? extends Callable2> aClass, String column) {
    ...
    public static SetFunctionType setFunctionType(Callable2<?, ?, ?> callable, String column) {

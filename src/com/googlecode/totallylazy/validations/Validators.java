...
public class Validators {
    ...
    public static <T, R> MapAndValidate<T, ? extends Iterable<? extends R>> forAll(Function1<? super T, ? extends Iterable<? extends R>> map, Validator<? super R> validator) {
        return mapAndValidate(map, everyItem(validator));
    }

    public static <T, R> MapAndValidate<T, R> validateThat(Function1<? super T, ? extends R> map, Validator<? super R> validator) {
        return mapAndValidate(map, validator);
    }

    public static <T, R> MapAndValidate<T, R> validateThat(Function1<? super T, ? extends R> map, Matcher<? super R> matcher) {
        return mapAndValidate(map, validateThat(matcher));
    }

    public static <T, R> MapAndValidate<T, R> validateThat(Function1<? super T, ? extends R> map, Predicate<? super R> predicate) {
        return mapAndValidate(map, validateThat(predicate));
    }

    public static <T, R> MapAndValidate<T, R> validateThat(Function1<? super T, ? extends R> map, Predicate<? super R> predicate, String message) {
        return mapAndValidate(map, validateThat(predicate, message));
    }

    public static <T, R> MapAndValidate<T, R> validateThat(Function1<? super T, ? extends R> map, Predicate<? super R> predicate, Function1<? super R, String> message) {
        return mapAndValidate(map, validateThat(predicate, message));
    }
    ...
    public static <T> PredicateValidator<T> validateThat(Predicate<? super T> predicate, Function1<? super T, String> message) {
        return validatePredicate(predicate, message);
    }

...
public final class TimeCallable1<A,B> extends Function1<A, B> {
    ...
    public static <A,B> TimeCallable1<A,B> time(Callable1<? super A, ? extends B> callable){
        return time(callable, TimeCallable.DEFAULT_REPORTER);
    }

    public static <A,B> TimeCallable1<A,B> time(Callable1<? super A, ? extends B> callable, Callable1<? super Number, ?> reporter){

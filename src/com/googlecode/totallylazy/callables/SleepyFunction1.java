...
public final class SleepyFunction1<T,R> implements Function1<T, R> {
    private final Function1<? super T, ? extends R> callable;
    private final int millis;

    private SleepyFunction1(Function1<? super T, ? extends R> callable, int millis) {
    ...
    public static <T,R> Function1<T, R> sleepy(Function1<? super T, ? extends R> callable, int millis) {
        return new SleepyFunction1<T,R>(callable, millis);
    }
}

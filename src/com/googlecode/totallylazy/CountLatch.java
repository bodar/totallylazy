...
public class CountLatch {
    ...
    public <A, B> Function<A, B> monitor(Function<? super A, ? extends B> callable) {
        return monitor(this, callable);
    }

    public static <A, B> Function<A, B> monitor(final CountLatch latch, final Function<? super A, ? extends B> callable) {
